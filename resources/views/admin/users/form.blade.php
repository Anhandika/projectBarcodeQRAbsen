...
<div><label class="text-sm font-semibold">Kelas / Jabatan</label><input name="class_name" value="{{ old('class_name',$user->class_name) }}" class="mt-1 w-full rounded-xl border border-school-line px-3 py-2.5 text-sm"></div>
